...
const STATUS_MAP = {
  ...
  hanout:     { cls: 'text-bg-success',   label: 'Commerce de proximité' },
  proximite:  { cls: 'text-bg-success',   label: 'Commerce de proximité' },
  pharmacie:  { cls: 'text-bg-primary',   label: 'Pharmacie' },
  cafe:       { cls: 'text-bg-secondary', label: 'Café' },
  snack:      { cls: 'text-bg-secondary', label: 'Snack' },
};
