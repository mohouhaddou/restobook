...
export const GAMES_REGISTRY = Object.freeze([
  {
    ...
    component: lazy(() => import('../games/phase-a/MemoryCardsGame')), options: { difficulties: ['easy', 'medium', 'hard'] },
  },
  {
    ...
    component: lazy(() => import('../games/phase-a/ReactionTestGame')), options: { rounds: 5 },
  },
  {
    ...
    component: lazy(() => import('../games/phase-a/ColorMatchGame')), options: { rounds: 12, accessibleMode: true },
  },
  {
    ...
    component: lazy(() => import('../games/phase-c/BubblePopGame')), options: { portrait: true },
  },
  {
    ...
    component: lazy(() => import('../games/phase-c/BrickSmashGame')), options: { levels: 3 },
  },
  {
    ...
    component: lazy(() => import('../games/phase-d/TowerStackGame')), options: { portrait: true },
  },
  {
    ...
    component: lazy(() => import('../games/phase-d/PenaltyMasterGame')), options: { modes: ['striker', 'keeper'] },
  },
  {
    ...
    component: lazy(() => import('../games/phase-e/SnakeGame')), options: { keyboard: true, touch: true },
  },
]);
