...
import { CartProvider } from './modules/marketplace/CartContext';
import { CustomerAuthProvider } from './modules/marketplace/CustomerAuthContext';
import { SubscriptionProvider } from './modules/subscriptions';
import { KidsProfileProvider } from './modules/kids-profile';
import { GamificationProvider } from './modules/gamification';
import { PlayProvider } from './modules/play/PlayContext';
...
import AdCampaignEditorPage from './pages/ads/AdCampaignEditorPage';
import AdPlacementsPage from './pages/ads/AdPlacementsPage';
import AdAnalyticsPage from './pages/ads/AdAnalyticsPage';
import HeroSlidesListPage  from './pages/marketplaceHero/HeroSlidesListPage';
import HeroSlideEditorPage from './pages/marketplaceHero/HeroSlideEditorPage';
import HeroSlideStatsPage  from './pages/marketplaceHero/HeroSlideStatsPage';
import ProfilePage   from './pages/ProfilePage';
import NotificationsPage from './pages/NotificationsPage';
import NotificationPreferencesPage from './pages/NotificationPreferencesPage';
import CustomerNotificationPreferencesPage from './pages/dashboard/NotificationPreferencesPage';
...
import PosSessionPage from './pages/pos/PosSessionPage';
...
import ArticlePage from './pages/discover/ArticlePage';
const GamingHubHomePage = lazy(() => import('./pages/gaminghub/GamingHubHomePage'));
const GameProfilePage = lazy(() => import('./pages/gaminghub/GameProfilePage'));
const GamingArticlesListPage = lazy(() => import('./pages/gaminghub/ArticlesListPage'));
const GamingArticleDetailPage = lazy(() => import('./pages/gaminghub/ArticleDetailPage'));
const GamingDiscoverFinderPage = lazy(() => import('./pages/gaminghub/DiscoverFinderPage'));
const GamingCategoriesListPage = lazy(() => import('./pages/gaminghub/CategoriesListPage'));
const GamingGamesListPage = lazy(() => import('./pages/gaminghub/GamesListPage'));
const GamingSearchPage = lazy(() => import('./pages/gaminghub/GamingSearchPage'));
const PortalPage = lazy(() => import('./pages/portals/PortalPage'));
const PortalDetailPage = lazy(() => import('./pages/portals/PortalDetailPage'));
const BookLandingPage = lazy(() => import('./pages/portals/BookLandingPage'));
const StoryReaderPage = lazy(() => import('./pages/portals/StoryReaderPage'));
const KidsAuthPage = lazy(() => import('./pages/portals/KidsAuthPage'));
const KidsProfilePage = lazy(() => import('./pages/portals/KidsProfilePage'));
const KidsPurchasesPage = lazy(() => import('./pages/portals/KidsPurchasesPage'));
const KidsPremiumPage = lazy(() => import('./pages/kids/KidsPremiumPage'));
const StudyHomePage = lazy(() => import('./pages/study/StudyHomePage'));
const StudyLessonPage = lazy(() => import('./pages/study/StudyLessonPage'));
const ComicsChrome = lazy(() => import('./modules/comics/ComicsChrome'));
const ComicsHomePage = lazy(() => import('./modules/comics/ComicsPages').then(module => ({ default: module.ComicsHomePage })));
const ComicsSearchPage = lazy(() => import('./modules/comics/ComicsPages').then(module => ({ default: module.ComicsSearchPage })));
const ComicDetailPage = lazy(() => import('./modules/comics/ComicsPages').then(module => ({ default: module.ComicDetailPage })));
const ComicsLibraryPage = lazy(() => import('./modules/comics/ComicsPages').then(module => ({ default: module.ComicsLibraryPage })));
const ComicReaderPage = lazy(() => import('./modules/comics/ComicsPages').then(module => ({ default: module.ComicReaderPage })));
const ComicsAdminDashboard = lazy(() => import('./modules/comics-dashboard/ComicsDashboard').then(module => ({ default: module.ComicsAdminDashboard })));
const ComicsAdminSeries = lazy(() => import('./modules/comics-dashboard/ComicsDashboard').then(module => ({ default: module.ComicsAdminSeries })));
const ComicsPublisherDashboard = lazy(() => import('./modules/comics-dashboard/ComicsDashboard').then(module => ({ default: module.ComicsPublisherDashboard })));
const ComicsImportWizard = lazy(() => import('./modules/comics-dashboard/ComicsDashboard').then(module => ({ default: module.ComicsImportWizard })));
const ComicsLoginPage = lazy(() => import('./modules/comics/ComicsAccount').then(module => ({ default: module.ComicsLoginPage })));
const ComicsUserDashboard = lazy(() => import('./modules/comics/ComicsAccount').then(module => ({ default: module.ComicsUserDashboard })));
const ComicsDashboardSection = lazy(() => import('./modules/comics-dashboard/ComicsDashboard').then(module => ({ default: module.ComicsDashboardSection })));
const ComicsSeriesEditor = lazy(() => import('./modules/comics-dashboard/ComicsEditorial').then(module => ({ default: module.ComicsSeriesEditor })));
const ComicsImportsPage = lazy(() => import('./modules/comics-dashboard/ComicsEditorial').then(module => ({ default: module.ComicsImportsPage })));
const AICommandCenter = lazy(() => import('./modules/ai-command-center/AICommandCenter'));
import ArticlesListPage from './pages/discover/admin/ArticlesListPage';
import ArticleEditorPage from './pages/discover/admin/ArticleEditorPage';
import DiscoverStatsPage from './pages/discover/admin/DiscoverStatsPage';
...
import HanoutPage          from './pages/hanout/HanoutPage';
import HanoutDashboard     from './pages/hanout/HanoutDashboard';
...
import DeliveryZonesPricingPage from './pages/DeliveryZonesPricingPage';
...
import { KidsLegacyRedirect, KidsBooksRedirect, KidsHomeOrSectionRoute } from './pages/kids/KidsLangRoutes';
import { SUPPORTED_LANGUAGES as KIDS_SUPPORTED_LANGUAGES } from './pages/kids/i18n';
import PlayChrome from './modules/play/components/PlayChrome';
const PlayHomePage = lazy(() => import('./pages/play/PlayHomePage'));
const PlayGamePage = lazy(() => import('./pages/play/PlayGamePage'));
const GameDetailsPage = lazy(() => import('./pages/play/GameDetailsPage'));
const PlayBadgesPage = lazy(() => import('./pages/play/PlayBadgesPage'));
const PlayRewardsPage = lazy(() => import('./pages/play/PlayRewardsPage'));
const PlayLeaderboardPage = lazy(() => import('./pages/play/PlayLeaderboardPage'));
const PlayProfilePage = lazy(() => import('./pages/play/PlayProfilePage'));
const PlayAuthPage = lazy(() => import('./pages/play/PlayAuthPage'));
...
import { CustomerDashboardLayout } from './shared/components/dashboard/CustomerDashboardLayout';
import DashboardHomePage       from './pages/dashboard/DashboardHomePage';
import ActivityPage            from './pages/dashboard/ActivityPage';
import ShoppingListsPage       from './pages/dashboard/ShoppingListsPage';
import WalletPage              from './pages/dashboard/WalletPage';
import InsightsPage            from './pages/dashboard/InsightsPage';
import DashboardProfilePage    from './pages/dashboard/DashboardProfilePage';
import IfilinoCardPage         from './pages/dashboard/IfilinoCardPage';
