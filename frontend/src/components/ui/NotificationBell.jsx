...
// ════════════════════════════════════════════════════════════════════════════
export function NotificationBell({ token, theme = 'light', onNavigate }) {
  ...
  // Poll unread count toutes les 30s
  useEffect(() => {
    fetchCount();
                ...
                {notifs.map(n => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Dismiss */}
                      <button onClick={e => dismiss(n, e)} style={{ background: 'none', border: 'none', cursor: 'pointer', color: muted, fontSize: 14, padding: '2px 4px', borderRadius: 4, flexShrink: 0, lineHeight: 1, fontFamily: 'inherit' }} title="Archiver">✕</button>
                    </div>
                  );
                })}
