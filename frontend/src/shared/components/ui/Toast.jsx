...
export function Toast({ msg, kind = 'info', onClose, autoHideMs = 6000 }) {
  ...
  return (
    <div role="status" aria-live="polite" style={{
      position: 'fixed', insetInlineEnd: 16, bottom: 16, maxWidth: 420, zIndex: 9999,
      ...
      <button className="btn btn-sm btn-outline-secondary" onClick={() => { setVisible(false); onClose?.(); }} aria-label={t('common.close')}>×</button>
