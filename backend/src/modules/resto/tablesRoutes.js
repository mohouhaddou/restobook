...
router.patch('/:id/status',
  ...
  async (req, res, next) => {
    try {
      ...
      // Notifier le client (si la réservation est liée à un compte, pas une
      // simple réservation invité) — seuls confirmed/cancelled ont un message
      // client dédié, voir onReservationStatusChanged.
      require('../../../services/NotificationService')
        .onReservationStatusChanged(resv, resv.status)
        .catch(() => {});
